...
RULES_BY_REL = {
    ...
    "conditional/if_branch_unify.cap0.out.json": "data/domains/conditional/if_branch.rewrites",
    "test/crossed_wrap_collapse.out.json": "data/test/crossed_wrap_collapse.rewrites",
    "test/strip_redundant_sibling_unsound.out.json": "data/test/strip_redundant_sibling_unsound.rewrites",
