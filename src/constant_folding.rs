...
//! - `!round6` — canonicalises every numeric literal to 6 decimal places,
//!   snapping float noise (e.g. `cos(pi/2) = 6e-17 => 0`) and unifying
//!   near-equal values (see [`round6_rewrite`]).
