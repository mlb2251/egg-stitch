...
fn follow_subtrees_equal<L: StitchLanguage>(follow: &RevExpr<ENodeOrVar<L>>, a: Id, b: Id) -> bool {
    if a == b {
        return true;
    }
...
pub fn check_follow<L: StitchLanguage>(pattern: &RevExpr<ENodeOrVar<L>>, pid: Id, follow: &RevExpr<ENodeOrVar<L>>, fid: Id, var_bindings: &mut HashMap<egg::Var, Id>) -> bool {
