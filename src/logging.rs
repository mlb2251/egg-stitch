...
pub fn apply_follow_constraint<L: StitchLanguage, P: PatternStorage<L>>(states: &[SearchState<L, P>], log_weights: &mut [f64], follow: &crate::revexpr::RevExpr<P>, shared: &SharedSearchData<L, P>, original_size: usize, costs: &[usize], verbose: bool) {
...
pub fn print_top_particles<L: StitchLanguage, P: PatternStorage<L>>(states: &[SearchState<L, P>], weights: &[f64], shared: &SharedSearchData<L, P>, original_size: usize, get_cost: impl Fn(usize) -> usize) {
