...
Domain helpers (``domain_type``, ``input_files``, ``rewrites_path``,
``scale_budget_for_domain``) live in :mod:`expts.runner`; the per-tool
subprocess wrappers in :mod:`expts.bench`.
"""
